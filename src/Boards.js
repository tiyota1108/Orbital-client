...
class Board extends Component {
	...
	componentWillMount() {//should i use will or did, i use will here to ensure the loading state works
		...
		fetch(`https://rocky-oasis-21711.herokuapp.com/note/${this.boardId}`, { //added in the second argument to specify token
			method: 'GET',
			headers: {
	...
	add(note) {
		var self = this;
		fetch(`https://rocky-oasis-21711.herokuapp.com/note/${this.boardId}`, {
			method: 'POST',
			headers: {
				'Accept': 'application/json',
				'Content-Type': 'application/json',
	...
	updateTitle(newNoteTitle, i) {
		var self = this;
		fetch(`https://rocky-oasis-21711.herokuapp.com/note/${i}`, {
			method: 'PUT',
			headers: {
				'Accept': 'application/json',
				'Content-Type': 'application/json',
	...
	remove(id) {
		...
		var self = this;
		fetch(`https://rocky-oasis-21711.herokuapp.com/note/${id}`, {
			method: 'DELETE',
			headers: {
				'Accept': 'application/json',
				'Content-Type': 'application/json',
	...
	flipNote(noteId, side) {
		var self = this;
		fetch(`https://rocky-oasis-21711.herokuapp.com/note/${noteId}`, {
			method: 'PUT',
			headers: {
				'Accept': 'application/json',
				'Content-Type': 'application/json',
